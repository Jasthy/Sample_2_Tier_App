...
<div class="alert alert-info">
  <b>After adding New Username/Password, will redirect to admin home page  
  </b>
</div>
...
<div class="container">
				...
				<div class="span8">
				<div class="alert alert-info">
					<b>Great!!</b> Employee general Details Added Successfully
					</div>
...
<div class="well">
<form class="form-horizontal" action="addEmps" method="post"> 
<fieldset>
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="textinput" name="adds.userName" type="text" placeholder="Employee New Username" class="input-xlarge">
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="passwordinput" name="adds.password" type="password" placeholder="Employee New Password" class="input-xlarge">
    <p class="help-block"></p>
  </div>
</div>
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="textinput" name="adds.bank_id" type="text" placeholder="Unique Bank Number" class="input-xlarge">
    <p class="help-block"></p>
  </div>
</div>
