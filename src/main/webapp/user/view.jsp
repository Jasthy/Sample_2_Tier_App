...
<html lang="en">
 ...
 Your Current Balance is : <b><s:property value="balance" /> Rs.</b>
</div>
...
<h4 class= "text-center" style="color: red;">All Transactions Details of Account: <s:property value="user1" /> </h4>
				...
				<table class="table table-striped table-bordered">
					...
					<s:iterator value="detailList" var="viewa">
						<tr>
