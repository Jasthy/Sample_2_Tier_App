...
<div class="span1"></div>
	...
	<s:if test="hasActionErrors()">
						...
						<meta http-equiv="refresh" content="4; url=empchangepw.jsp" />
					</s:if>
					...
					<meta http-equiv="refresh" content="6; url=welcome.jsp" />
					</s:if>
					</div>
					<div class="span2"></div>
					</div>
...
<div class="span8">					
<form class="form-horizontal" action="adm_emp_changepw" method="post">
<fieldset>

<!-- Form Name -->
<h4>Admin Employee Change Password</h4>

<!-- Text input-->
<div class="control-group">
  <label class="control-label">Bank Employee Id</label>
  <div class="controls">
    <input id="textinput" name="chpw.bank_id" type="text" placeholder="Enter Employee Id" class="input-xlarge">
