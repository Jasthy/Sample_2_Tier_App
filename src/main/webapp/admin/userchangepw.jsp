...
<div class="span1"></div>
	...
	<s:if test="hasActionErrors()">
						...
						<meta http-equiv="refresh" content="4; url=userchangepw.jsp" />
					</s:if>
...
<div class="span8">					
<form class="form-horizontal" action="adm_user_changepw" method="post">
<fieldset>

<!-- Form Name -->
<h4>Admin Client Change Password</h4>

<!-- Text input-->
<div class="control-group">
  <label class="control-label">Bank Client Id</label>
  <div class="controls">
    <input id="textinput" name="chpw.bank_id" type="text" placeholder="Enter Bank Client Id" class="input-xlarge">
