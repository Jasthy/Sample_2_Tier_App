...
<div class="control-group">
  ...
  <div class="controls">
    <input id="textinput" name="add.bank_id" type="text" placeholder="Unique Bank Number" class="input-xlarge">
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="textinput" name="add.role_name" type="text" placeholder="Employee Role" class="input-xlarge">
    <p class="help-block"></p>
  </div>
</div>
